# -*- coding: utf-8 -*-
"""
Created on Mon May 31 20:20:23 2021

@author: Admin
"""
import sys
sys.path.insert(0,"D:/MHS detection")
import config
import torch
...
if __name__ == "__main__":
    ...
    train_loader, test_loader = get_loaders("D:/MHS data box labeling/data/l_train.npy", "D:/MHS data box labeling/data/test.npy")
    ...
    for epoch in range(1,config.NUM_EPOCHS+1):
        ...
        if epoch % 1 == 0:
            ...
            print("\n########################################################################################################################################################")
            print("MAP: {:0.4f}".format(mapval.item()))
            print("########################################################################################################################################################")
            
            if mapval.item()>=best_mapv:
                best_mapv = mapval.item()
