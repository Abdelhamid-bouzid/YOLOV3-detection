...
class YOLODataset(Dataset):
    def __init__(self,path,anchors,image_size=300,S=[13, 26, 52],C=1,transform=None):
    ...
    def __getitem__(self, index):
        ...
        bboxes = self.dataset["labels"][index].tolist()
...
def test():
    ...
    dataset        = YOLODataset("D:/MHS data box labeling/data/l_train.npy",anchors=anchors,S=[13, 26, 52],transform=None)
    S              = [13, 26, 52]
